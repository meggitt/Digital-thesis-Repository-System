...
import '../css/AboutUs.css'; // Import the CSS file for styling the footer
    ...
    return (
        <div className="footer"> {/* The main container for the footer */}
            <div className='inputF'> {/* A div to hold the navigation links */}
                ...
                <Link to='/aboutUs'>About Us</Link> {/* Link to About Us page */}
                <Link to='/contactUs'>Contact Us</Link> {/* Link to Contact Us page */}
                <Link to='/faq'>FAQs</Link> {/* Link to FAQs page */}
            </div>
