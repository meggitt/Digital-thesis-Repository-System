...
function PendingRefAdvisorThesisCard({ thesis, isTrending, handleApprove, handleDecline }) {
    ...
    return (
        <div className="thesis-card">
            ...
            <div className="thesis-actions">
                <button className="view-btn" style={{ backgroundColor: 'green' }} onClick={handleApprove}>Approve</button>
                <button className="view-btn" style={{ backgroundColor: 'red' }} onClick={handleDecline}>Decline</button>
            </div>
            <div className="thesis-actions">
...
export default PendingRefAdvisorThesisCard;